    ...
    <div class="container">
        <form action="{{ route('events.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="date" name="prize_date"  id="exampleInputEmail1" >
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">报名人数限制</label>
                <input type="text" name="signup_num" class="form-control" id="exampleInputEmail1" placeholder="报名人数" value="{{ old('signup_num') }}">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">是否已开奖</label><br>
                {{--是<input type="radio" name="is_prize"  id="exampleInputEmail1" value="1">--}}
                否<input type="radio" name="is_prize"  id="exampleInputEmail1" value="0" checked>
            </div>
            <div class="form-group">
